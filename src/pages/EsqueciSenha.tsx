  ...
  return (
    <div className="min-h-screen bg-bege flex items-center justify-center p-4">
      <div className="flex flex-col gap-4 bg-white border-4 border-black rounded-3xl p-8 w-full max-w-sm shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
        ...
        <CardTitle className="text-ciano text-center text-4xl mt-6">Recuperar Senha</CardTitle>
        ...
        {success ? (
          ...
          <div className="flex flex-col items-center gap-4 py-6 text-center animate-fadeIn">
            ...
            <p className="font-texto text-sm text-black/70">
              Se o e-mail <b>{email}</b> estiver cadastrado no sistema, você receberá um link de redefinição válido por 15 minutos.
            </p>
            <Button variant="primary" onClick={() => navigate("/")} className="mt-4 w-full justify-center">
              Voltar ao Login
            </Button>
          </div>
        ) : (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <label className="text-cianoEscuro text-sm font-bold font-texto ml-1">E-mail Cadastrado</label>
              <input
                type="email"
                value={email}
            ...
            <Button variant="primary" type="submit" disabled={loading} className="mt-4 w-full justify-center">

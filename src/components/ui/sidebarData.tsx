import { HomeIcon, PawPrint, Users, Stethoscope, CalendarDays, ShieldCheck } from "lucide-react";
...
const all = [
  ...
  { title: "Veterinários", icon: <Stethoscope />,  link: "/veterinarios", roles: ["ADMIN", "FUNCIONARIO"] },
